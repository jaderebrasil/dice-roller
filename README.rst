...
Documentation (Draft)
=====================
Roll three d6 and return the **sum**::

    $ python -m jarniadice '3d6'

Roll two d10 and return the value of the **higher**::

    $ python -m jarniadice '2d10kh'

Roll two d10 and return the value of the **lower**::

    $ python -m jarniadice '2d10kl'

Roll two d10 and return **all** the values as a
